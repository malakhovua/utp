...
- використовувати стиль написання коду для керованих форм 1с 8.3 версії (8.3.18.1483)
- код має бути стандартизований під код УТП. Дивитися документ - РеализацияТоваровУслуг
