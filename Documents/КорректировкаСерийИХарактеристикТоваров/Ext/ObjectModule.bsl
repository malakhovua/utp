...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("МакетДокумента", НСтр("ru='Корректировка серий и характеристик товаров';uk='Коригування серій і характеристик товарів'",Локализация.КодЯзыкаИнформационнойБазы()));
...
Процедура ДвиженияПоРегистрамРегл(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоТоварам, Отказ, Заголовок)
	...
	Если ВестиУчетПоДопРазрезамРегл Тогда
		УправлениеЗапасамиПартионныйУчет.ДвижениеПартийТоваров(Ссылка, ТаблицаПоТоварам, , Ложь, СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете, , , Отказ, ,НСтр("ru='Корректировка серий и характеристик товаров';uk='Коригування серій і характеристик товарів'",Локализация.КодЯзыкаИнформационнойБазы()));
