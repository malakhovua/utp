...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("Акт,М21",НСтр("ru='Акт инвентаризации товаров на складе';uk='Акт інвентаризації товарів на складі'"),НСтр("ru='Инвентаризационная опись (М-21)';uk='Інвентаризаційний опис (М-21)'"));
...
//  Табличный документ - печатная форма накладной
//
Процедура ПерезаполнитьУчетныеКоличестваУпр(ПостроительОтчета, ЗаполнениеПоДаннымРеглУчета = Ложь) Экспорт
...
// Заполняет документ по остаткам на складе
// 
Процедура ЗаполнитьПоОстаткамНаСкладеРегл(ПостроительОтчета) Экспорт
