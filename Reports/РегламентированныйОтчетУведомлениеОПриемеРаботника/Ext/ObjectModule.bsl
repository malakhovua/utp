...
НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2024";
НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена пост-нием КМУ N 413 от 17.06.15г.(в редакции пост-ния КМУ от 23.08.24г. N 967).';uk='Затверджено постановою КМУ N 413 від 17.06.15р.(в редакції пост. від 23.08.24р. N 967).'"); 
