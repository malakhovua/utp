...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	НСтр("ru='Штрих-код';uk='Штрихкод'", КодЯзыкаПечать));
...
Процедура _ДобавитьВТекстСвойстваИКатегории(ТаблицаПолей, Текст, СтруктураПредставлениеПолей, мСоответствиеНазначений, 
	...
	Пока СвойстваОбъектов.Следующий() Цикл
		...
		Для каждого Поле из Поля Цикл
			...
			СтруктураПредставлениеПолей.Вставить("Свойство" + Индекс + "Значение", СвойстваОбъектов.Наименование + НСтр("ru = ' (св-во '; uk = ' (вл-ть '")  + Поле.Представление + ")");

			мСоответствиеНазначений.Вставить(СвойстваОбъектов.Наименование + НСтр("ru = ' (св-во '; uk = ' (вл-ть '")  + Поле.Представление + ")", СвойстваОбъектов.Ссылка);
