...
Функция ПолучитьСотрудников( УсловиеНаФизлицо = "" )
	...
	|			 И Состояния.Состояние <> ЗНАЧЕНИЕ(Перечисление.СостоянияРаботникаОрганизации.ПриостановкаТрудовогоДоговора)
	| ))
	|			" + УсловиеНаФизлицо + "
	|
	|			ОБЪЕДИНИТЬ ВСЕ
	...
	|			 ИЛИ СостоянияДо.Состояние = ЗНАЧЕНИЕ(Перечисление.СостоянияРаботникаОрганизации.ПриостановкаТрудовогоДоговора))
	...
	|					  ИЛИ Состояния.Состояние = ЗНАЧЕНИЕ(Перечисление.СостоянияРаботникаОрганизации.ПриостановкаТрудовогоДоговора)) 
    |					И	Состояния.Период >= &парамНачало
	|					И	Состояния.Период <= &парамКонец
	|
