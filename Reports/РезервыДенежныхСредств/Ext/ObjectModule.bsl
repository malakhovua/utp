...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ДенежныеСредстваВРезервеОстатки.ДокументРезервирования",            "ДокументРезервирования", НСтр("ru = 'Документ резервирования'; uk = 'Документ резервування'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Документы);
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля( "ДенежныеСредстваВРезервеОстатки.Организация" , "Организация", НСтр("ru='Организация';uk='Організація'"), ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_Организации);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВалютаДенежныхСредств",  НСтр("ru = 'Валюта Банка/кассы'; uk = 'Валюта Банку/каси'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДокументРезервирования", НСтр("ru = 'Документ резервирования'; uk = 'Документ резервування'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("БанковскийСчетКасса",    НСтр("ru = 'Банк/касса'; uk = 'Банк/каса'"));
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СуммаОстаток",           НСтр("ru = 'Сумма в валюте банковского счета/кассы'; uk = 'Сума у валюті банківського рахунку/каси'"));
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаОстаток", НСтр("ru = 'Сумма в валюте банковского счета/кассы'; uk = 'Сума у валюті банківського рахунку/каси'"), Истина, "ЧЦ=15; ЧДЦ=2");
