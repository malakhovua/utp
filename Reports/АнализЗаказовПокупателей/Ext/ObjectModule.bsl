...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Предоплата", НСтр("ru='Предоплата';uk='Передоплата'"));
	...
	УниверсальныйОтчет.ДобавитьПоказатель("Предоплата",         НСтр("ru='Предоплата';uk='Передоплата'"),        Истина, "ЧЦ=15; ЧДЦ=2", "Оплата", "Оплата");
