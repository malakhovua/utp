...
Процедура СформироватьОтчет(ДокументРезультат, ЕстьОшибки) Экспорт
	...
	ТекстОсновногоЗапроса ="ВЫБРАТЬ
				  ...
				  |	ИЗ
				  |		РегистрСведений.РаботникиОрганизаций.СрезПоследних(&ДатаАктуальности,(Сотрудник.ВидЗанятости В (&ВидЗанятостиОсновноеМестоРаботы) ИЛИ (Сотрудник.ВидЗанятости) ЕСТЬ NULL)) КАК РаботникиОрганизацииСрезПоследних
	              |	
	              |	ГДЕ
