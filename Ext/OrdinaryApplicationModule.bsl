...
Процедура ПриНачалеРаботыСистемы()
	...
	Если НЕ ВключенИнтерфейсКассира Тогда
		...
		//Если Ложь 
		// Или ПервыйЗапуск Тогда // + - umk
		Если ОткрытьПанельФункций ИЛИ ПервыйЗапуск Тогда
	...
	// + umk
	umk_ПолныеПраваКлиент.УстановитьПараметрСеансаПоОрганизации(Истина, ЗаголовокСистемы);
	// - umk
...
// + umk 
Процедура ИнтерфейсКассира_umk_ЧекиККМ_Действие() Экспорт
	
	ОткрытьФорму("Документ.ЧекККМ.ФормаСписка");
	
КонецПроцедуры

Процедура ИнтерфейсКассира_umk_РРО_Действие() Экспорт
	
	ОткрытьФорму("Обработка.ИнтерфесКассира.Форма.Форма");
	
КонецПроцедуры

Процедура ИнтерфейсКассира_ВнесениеНаличныхСредст() Экспорт
	
	Форма = ПолучитьФорму("Обработка.ИнтерфесКассира.Форма.Форма");
	
	Если Форма.Открыта() Тогда
		Форма.Закрыть();
	КонецЕсли;
	
	Форма.ТолькоВнесение = Истина;
	Форма.Открыть();
