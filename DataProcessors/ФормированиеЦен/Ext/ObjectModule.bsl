...
Процедура ЗаполнитьПостроительОтчетаПоЦенамНоменклатуры(ВключатьНезаполненные, ЗаполнятьТолькоТекстЗапроса) Экспорт
	...
	Если Не ЗаполнятьТолькоТекстЗапроса Тогда
		...
		НСтр("ru = 'Номенклатурная группа'; uk = 'Номенклатурна група'"),
		НСтр("ru = 'Ценовая группа'; uk = 'Цінова група'"), 
		НСтр("ru = 'Группа'; uk = 'Група'"));
		...
		Иначе
			ЭлементОтбора = ПостроительОтчета.Отбор.Добавить("ТипЦен",, НСтр("ru = 'Тип цен'; uk = 'Тип цін'"));
		...
		Иначе
			ЭлементОтбора = ПостроительОтчета.Отбор.Добавить("Номенклатура",, НСтр("ru = 'Номенклатура'; uk = 'Номенклатура'"));
			ЭлементОтбора.ВидСравнения  = ВидСравнения.ВСписке;
