...
Процедура ЗаполнитьПодвалНалоговогоДокумента(НалоговыйДокумент)
	...
	СтруктураТабличныйЧастей = Новый Структура("Товары, Услуги");
	Для каждого ЭлементСтруктуры Из СтруктураТабличныйЧастей Цикл
		НалоговыйДокумент.ЗаполнитьСчетаУчетаВТабЧасти(НалоговыйДокумент[ЭлементСтруктуры.Ключ], ЭлементСтруктуры.Ключ);		
	КонецЦикла;		
	НалоговыйДокумент.ЗаполнитьСуммыРегл();
	НалоговыйДокумент.ЗаполнитьВесТоваров();
