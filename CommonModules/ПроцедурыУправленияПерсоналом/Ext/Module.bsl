...
Процедура ПроставитьДанныеСтроки(Сотрудник, ДатаСобытия, ЭлементФормы) Экспорт
	...
	|	РаботникиОрганизации.РаботаСНефиксированнымРабочимВременем КАК РаботаСНефиксированнымРабочимВременем,
	|	Работники.ЗанимаемыхСтавок КАК ЗанимаемыхСтавокУпр,
	...
	Если ТипЗнч(ЭлементФормы) = Тип("ТабличноеПоле") Тогда
		...
		Если ЭлементФормы.Колонки.Найти("РаботаСНефиксированнымРабочимВременем") <> Неопределено Тогда
			ЭлементФормы.ТекущаяСтрока.РаботаСНефиксированнымРабочимВременем = НаборыДанных[0].РаботаСНефиксированнымРабочимВременем;
		КонецЕсли;
