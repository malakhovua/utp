...
Функция ПолучитьСписокВыбораСпецРежимНалогообложения() Экспорт
	...
	мСписокВыбораСпецРежимНалогообложения.Добавить(2, "(до 01.04.2023) 2 Платники, включені до реєстру отримувачів бюджетної дотації.
	...
	мСписокВыбораСпецРежимНалогообложения.Добавить(7, "7-складання податкової накладної за операцією з вивезення за межі митної території України
