		...
		Если НастройкаОбменаДанными.ВыполнятьДействияПодПолнымиПравами Тогда
			...
			#Если Клиент Тогда
				...
				Если НЕ ИнформационнаяБазаФайловая Тогда
					Сообщить(НСтр("ru='Начат обмен данными под полными правами на сервере платформы по настройке ""';uk='Почато обмін даними під повними правами на сервері платформи по настройці ""'") + Строка(НастройкаОбменаДанными) + """ " + ТекущаяДата() + Символы.ПС);
				КонецЕсли;
			#КонецЕсли
			...
			#Если Клиент Тогда
				Если НЕ ИнформационнаяБазаФайловая Тогда
					Сообщить(НСтр("ru='Завершен обмен данными под полными правами на сервере платформы по настройке ""';uk='Завершено обмін даними під повними правами на сервері платформи по настройці ""'") + Строка(НастройкаОбменаДанными) + """ " + ТекущаяДата() + Символы.ПС);
				КонецЕсли;
			#КонецЕсли
...
Процедура ВыполнитьОбменПоНастройкеАвтоматическогоВыполненияОбменаДанными(НастройкаОбменаДанными, РучнойЗапускОбменов = Истина, ОбработкаАвтообменаНаКлиенте = Неопределено, 
	...
	Если НастройкаОбменаДанными.ВыполнятьДействияПодПолнымиПравами Тогда
		...
		#Если Клиент Тогда
			ИнформационнаяБазаФайловая = ОпределитьЭтаИнформационнаяБазаФайловая();
			Если НЕ ИнформационнаяБазаФайловая Тогда
				Сообщить(НСтр("ru='Начат обмен данными под полными правами на сервере платформы по настройке автоматического обмена ""';uk='Почато обмін даними під повними правами на сервері платформи по настройці автоматичного обміну ""'") + Строка(НастройкаОбменаДанными) + """ " + ТекущаяДата() + Символы.ПС);
			КонецЕсли;
		#КонецЕсли
		...
		#Если Клиент Тогда
			Если НЕ ИнформационнаяБазаФайловая Тогда	
				Сообщить(НСтр("ru='Завершен обмен данными под полными правами на сервере платформы по настройке автоматического обмена ""';uk='Завершено обмін даними під повними правами на сервері платформи по настройці автоматичного обміну ""'") + Строка(НастройкаОбменаДанными) + """ " + ТекущаяДата() + Символы.ПС);
			КонецЕсли;
		#КонецЕсли
