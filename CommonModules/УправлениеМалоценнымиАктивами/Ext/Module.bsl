...
Процедура СписатьПартиюМалоценки(ТипУчета, КоэфСписания, СтруктураОстатков, СтрокаТЧ, Выборка, СтруктураШапкиДокумента, ТаблицаДвижений, Проводки)
	...
	ИначеЕсли ТипУчета = "Бух" Тогда
		...
		Если СтруктураШапкиДокумента.КодОперации = "Перемещение" Тогда
			...
			Содержание = НСтр("ru='Перемещение малоценки в эксплуатации';uk='Переміщення малоцінки в експлуатації'",Локализация.КодЯзыкаИнформационнойБазы());
			
		Иначе // Списание
			
			Содержание = НСтр("ru='Списание малоценки из эксплуатации';uk='Списання малоцінки з експлуатації'",Локализация.КодЯзыкаИнформационнойБазы());
