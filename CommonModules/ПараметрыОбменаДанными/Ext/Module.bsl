...
Функция ПолучитьТаблицуВозможныхОбменовСРознинойТорговлей() Экспорт
	...
	СтрокаТаблицы.ПредставлениеКонфигурации = НСтр("ru='Розница 8 для Украины (начиная с версии 1.0)';uk='Роздріб 8 для України (починаючи з версії 1.0)'"); // представление для пользователя
...
Функция ПолучитьИнформациюОТекущейИнформационнойБазе() Экспорт
	...
	СтруктураДанных.Вставить("ПредставлениеКонфигурации", НСтр("ru='Управление торговым предприятем для Украины (начиная с версии 1.1)';uk='Управління торговим підприємством для України (починаючи з версії 1.1)'"));
