...
Функция СфомироватьСообщениеБлокировки(Знач Сообщение, Знач КодРазрешения) Экспорт
	...
	ТекстСообщения = ТекстСообщения +
		...
		НСтр("ru='Чтобы принудительно разблокировать информационную базу, воспользуйтесь консолью кластера серверов или запустите ""Предприятие"" с параметрами:';uk='Для того, аби примусово розблокувати інформаційну базу, скористуйтеся консолью кластеру серверів або запустіть ""Підприємство"" з параметрами:'") + Символы.ПС +
...
// Вернуть имя COM-класса для работы с платформой через COM-соединение.
